...
// {
// const pedirNombre = document.getElementById('pedirNombre')

// const itemList = document.createElement('p')
// itemList.innerHTML = `<label>Nombre completo</label>
// <input type="text" name="fullname">`

// pedirNombre.appendChild(itemList)
...
// const itemList = document.createElement('p')
// itemList.innerHTML = `<label>Correo electronico</label>
...
// const itemList = document.createElement('p')
// itemList.innerHTML = `<label>Numero de telefono</label>
...
// const itemList = document.createElement('p')
// itemList.innerHTML = `<label>Asunto</label>
...
// itemList.innerHTML = `<label>Mensaje</label> 
...
// itemList.innerHTML = `<button>Enviar</button>`
